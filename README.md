...
plugin {
    hymission {
        ...
        niri_overview_open_close_speed_multiplier = 1.8
        toggle_switch_mode = 1
        switch_toggle_auto_next = 1
        switch_release_key = Super_L
...
| `niri_overview_open_close_speed_multiplier` | float | `1.8` | Speed multiplier applied to the live `windowsMove` animation for niri single-workspace overview open and close transitions. The configured curve and style are preserved. |
