...
constexpr auto   DIRECT_NIRI_HEAVY_EDIT_EXTRA_DELAY = std::chrono::milliseconds(350);
constexpr auto   DIRECT_NIRI_HEAVY_EDIT_POST_SETTLE = std::chrono::milliseconds(530);
